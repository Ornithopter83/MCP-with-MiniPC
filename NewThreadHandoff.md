...
- 완료: 평상시 Agent의 대용량 자동 hash/upload/reconciliation 경로 제거. `ProjectHub_Sync.ps1` 고정 manifest와 별도 `ProjectHub_LargeData_Uploader.ps1`의 chunk resume/finalize, STAGED·CHECKPOINTED metadata 경로 구현
